        ...
        if (this.auth) {
            ...
            switch (this.auth.type) {
               case "xauth":
                    ...
                    if (this.auth.access_token && this.auth.access_token_secret) { 
                      params.oauth_token = this.auth.access_token;
                      params.oauth_token_secret = this.auth.access_token_secret;
                    }
                    ...
                    headers['oauth_version']          = params.oauth_version;
                    headers['oauth_consumer_key']     = params.oauth_consumer_key;
                    headers['oauth_signature_method'] = params.oauth_signature_method;
                    headers['oauth_nonce']            = params.oauth_nonce;
                    headers['oauth_timestamp']        = params.oauth_timestamp;

                    if (params.access_token && params.access_token_secret) { 
                        headers.oauth_token = params.access_token;
                        headers.oauth_token_secret = params.access_token_secret;
                    }

                    // Sign the header.
                    headers['oauth_signature']        = authUtil.signRequest(params, options);
